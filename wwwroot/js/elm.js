...
var $author$project$MasterTools$Main$main = $elm$browser$Browser$element(
	{
		init: $author$project$MasterTools$Main$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$MasterTools$Main$update,
		view: $author$project$MasterTools$Main$view
	});
		...
		return function (level) {
			return function (health) {
				return function (maxHealth) {
					return function (tempHealth) {
						return function (gold) {
							return function (silver) {
								return function (copper) {
									return function (electrum) {
										return function (platinum) {
											return function (name) {
												return function (description) {
													return function (race) {
														return function (alignment) {
															return function (experiencePoints) {
																return function (proficiencyBonus) {
																	return function (speed) {
																		return function (hitDice) {
																			return function (hasInspiration) {
																				return function (characterClasses) {
																					return function (abilities) {
																						return function (inventoryItems) {
																							return function (proficiencyBonuses) {
																								return function (spells) {
																									return function (spellSlots) {
																										return {abilities: abilities, alignment: alignment, characterClasses: characterClasses, copper: copper, description: description, electrum: electrum, experiencePoints: experiencePoints, gold: gold, hasInspiration: hasInspiration, health: health, hitDice: hitDice, id: id, inventoryItems: inventoryItems, level: level, maxHealth: maxHealth, name: name, platinum: platinum, proficiencyBonus: proficiencyBonus, proficiencyBonuses: proficiencyBonuses, race: race, silver: silver, speed: speed, spellSlots: spellSlots, spells: spells, tempHealth: tempHealth, userId: userId};
																									};
																								};
																							};
																						};
...
var $author$project$Common$Character$abilityDecoder = A3(
...
var $author$project$Common$Character$characterClassDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'level',
	$elm$json$Json$Decode$int,
	A3(
		...
		'name',
		$elm$json$Json$Decode$string,
		$elm$json$Json$Decode$succeed($author$project$Common$Character$CharacterClass)));
var $author$project$Common$Character$InventoryItem = function (name) {
	return {name: name};
};
var $author$project$Common$Character$inventoryItemDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'name',
	$elm$json$Json$Decode$string,
...
var $author$project$Common$Character$Acrobatics = {$: 'Acrobatics'};
var $author$project$Common$Character$AnimalHandling = {$: 'AnimalHandling'};
var $author$project$Common$Character$Arcana = {$: 'Arcana'};
var $author$project$Common$Character$Athletics = {$: 'Athletics'};
var $author$project$Common$Character$Deception = {$: 'Deception'};
var $author$project$Common$Character$History = {$: 'History'};
var $author$project$Common$Character$Insight = {$: 'Insight'};
var $author$project$Common$Character$Intimidation = {$: 'Intimidation'};
var $author$project$Common$Character$Investigation = {$: 'Investigation'};
var $author$project$Common$Character$Medicine = {$: 'Medicine'};
var $author$project$Common$Character$Nature = {$: 'Nature'};
var $author$project$Common$Character$Perception = {$: 'Perception'};
var $author$project$Common$Character$Performance = {$: 'Performance'};
var $author$project$Common$Character$Persuasion = {$: 'Persuasion'};
var $author$project$Common$Character$Religion = {$: 'Religion'};
var $author$project$Common$Character$SleightOfHand = {$: 'SleightOfHand'};
var $author$project$Common$Character$Stealth = {$: 'Stealth'};
var $author$project$Common$Character$Survival = {$: 'Survival'};
var $author$project$Common$Character$skillTypeDecoder = A2(
	$elm$json$Json$Decode$map,
	function (skillType) {
		switch (skillType) {
			case 'Acrobatics':
				return $author$project$Common$Character$Acrobatics;
			case 'AnimalHandling':
				return $author$project$Common$Character$AnimalHandling;
			case 'Arcana':
				return $author$project$Common$Character$Arcana;
			case 'Athletics':
				return $author$project$Common$Character$Athletics;
			case 'Deception':
				return $author$project$Common$Character$Deception;
			case 'History':
				return $author$project$Common$Character$History;
			case 'Insight':
				return $author$project$Common$Character$Insight;
			case 'Intimidation':
				return $author$project$Common$Character$Intimidation;
			case 'Investigation':
				return $author$project$Common$Character$Investigation;
			case 'Medicine':
				return $author$project$Common$Character$Medicine;
			case 'Nature':
				return $author$project$Common$Character$Nature;
			case 'Perception':
				return $author$project$Common$Character$Perception;
			case 'Performance':
				return $author$project$Common$Character$Performance;
			case 'Persuasion':
				return $author$project$Common$Character$Persuasion;
			case 'Religion':
				return $author$project$Common$Character$Religion;
			case 'SleightOfHand':
				return $author$project$Common$Character$SleightOfHand;
			case 'Stealth':
				return $author$project$Common$Character$Stealth;
			case 'Survival':
				return $author$project$Common$Character$Survival;
			default:
				return $author$project$Common$Character$Acrobatics;
		}
	},
	$elm$json$Json$Decode$string);
var $author$project$Common$Character$Charisma = {$: 'Charisma'};
var $author$project$Common$Character$Constitution = {$: 'Constitution'};
var $author$project$Common$Character$Dexterity = {$: 'Dexterity'};
var $author$project$Common$Character$Intelligence = {$: 'Intelligence'};
var $author$project$Common$Character$Strength = {$: 'Strength'};
var $author$project$Common$Character$Wisdom = {$: 'Wisdom'};
var $author$project$Common$Character$statTypeDecoder = A2(
	$elm$json$Json$Decode$map,
	function (statType) {
		switch (statType) {
			case 'Strength':
				return $author$project$Common$Character$Strength;
			case 'Dexterity':
				return $author$project$Common$Character$Dexterity;
			case 'Constitution':
				return $author$project$Common$Character$Constitution;
			case 'Intelligence':
				return $author$project$Common$Character$Intelligence;
			case 'Wisdom':
				return $author$project$Common$Character$Wisdom;
			case 'Charisma':
				return $author$project$Common$Character$Charisma;
			default:
				return $author$project$Common$Character$Strength;
		}
	},
	$elm$json$Json$Decode$string);
var $author$project$Common$Character$proficiencyBonusDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'statType',
	$author$project$Common$Character$statTypeDecoder,
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'skillType',
		$author$project$Common$Character$skillTypeDecoder,
		$elm$json$Json$Decode$succeed($author$project$Common$Character$ProficiencyBonus)));
var $author$project$Common$Character$Spell = F2(
	function (level, name) {
		return {level: level, name: name};
	});
var $author$project$Common$Character$spellDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'name',
	$elm$json$Json$Decode$string,
	A3(
		...
		'level',
		$elm$json$Json$Decode$int,
		$elm$json$Json$Decode$succeed($author$project$Common$Character$Spell)));
var $author$project$Common$Character$SpellSlot = F3(
	function (level, remainingUses, maxUses) {
		return {level: level, maxUses: maxUses, remainingUses: remainingUses};
	});
var $author$project$Common$Character$spellSlotDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'maxUses',
	$elm$json$Json$Decode$int,
	A3(
		...
		A3(
			...
			'level',
			$elm$json$Json$Decode$int,
			$elm$json$Json$Decode$succeed($author$project$Common$Character$SpellSlot))));
var $author$project$Common$Character$characterDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'spellSlots',
	$elm$json$Json$Decode$list($author$project$Common$Character$spellSlotDecoder),
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'spells',
		$elm$json$Json$Decode$list($author$project$Common$Character$spellDecoder),
		A3(
			$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'proficiencyBonuses',
			$elm$json$Json$Decode$list($author$project$Common$Character$proficiencyBonusDecoder),
			A3(
				$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
				'inventoryItems',
				$elm$json$Json$Decode$list($author$project$Common$Character$inventoryItemDecoder),
				A3(
					$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
					'abilities',
					$elm$json$Json$Decode$list($author$project$Common$Character$abilityDecoder),
					A3(
						$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'characterClasses',
						$elm$json$Json$Decode$list($author$project$Common$Character$characterClassDecoder),
						A3(
							$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
							'hasInspiration',
...
var $author$project$CharacterSheet$Main$flagsDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'character',
	$author$project$Common$Character$characterDecoder,
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$requiredAt,
		_List_Nil,
...
var $author$project$CharacterSheet$Main$main = $elm$browser$Browser$element(
	{
		init: $author$project$CharacterSheet$Main$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
